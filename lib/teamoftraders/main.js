...
const uiState = { revealDay: Infinity, highlightId: null };
...
buildScene();
initInteract(index, { scroller, stage, markersRef, uiState });
...
if (STATIC_MODE) {
  ...
  const tick = t => {
    ...
    renderer.draw({ revealDay: uiState.revealDay, t, panX, highlightId: uiState.highlightId });
