...
// mark composites over whatever sits behind it.
// `empty: true` means the renderer leaves the canvas blank — used by the splash
// where the mark is painted live frame-by-frame by lib/logo/mark-animator.js.
export const VARIANTS = Object.freeze({
  ...
  splash:   { bg: null, color: '220, 180, 100', empty: true },
});
