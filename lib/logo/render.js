...
const MASTER_RES = 1024;
const BOOST = 2.4;
const BASE_ALPHA = 0.07;        // before boost; spec §3
const DOT_SIZE = 2.5;           // at master resolution
const PADDING = 0.85;           // fraction of half-canvas radius
